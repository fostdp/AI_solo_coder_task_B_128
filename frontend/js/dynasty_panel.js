    ...
    renderArchaeologySection() {
        ...
        div.innerHTML = `
            <div style="background:#0f172a;padding:12px;border-radius:6px;border-top:3px solid #10b981;">
                <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="DynastyPanel.toggleSection('archaeology')">
    ...
    renderDocumentsSection() {
        ...
        div.innerHTML = `
            <div style="background:#0f172a;padding:12px;border-radius:6px;border-top:3px solid #a855f7;">
                <div style="display:flex;justify-content:space-between;align-items:center;cursor:pointer;" onclick="DynastyPanel.toggleSection('documents')">
