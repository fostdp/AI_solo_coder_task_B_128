...
class VirtualCaravanServiceTest {
    ...
    @InjectMocks
    private VirtualCaravanService virtualCaravanService;
    ...
    void createVirtualCaravan_validRequest_setsStatusPreparing() {
        ...
        VirtualCaravanDTO result = virtualCaravanService.createVirtualCaravan(req);
    ...
    void createVirtualCaravan_shouldCreateJourneyStartEvent() {
        ...
        virtualCaravanService.createVirtualCaravan(req);
    ...
    void startJourney_fromPreparing_changesStatusToTraveling() {
        ...
        VirtualCaravanDTO result = virtualCaravanService.startJourney(1L);
    ...
    void pauseJourney_travelingToResting_statusChanges() {
        ...
        VirtualCaravanDTO result = virtualCaravanService.pauseJourney(1L);
    ...
    void resumeJourney_restingBackToTraveling_statusChanges() {
        ...
        VirtualCaravanDTO result = virtualCaravanService.resumeJourney(1L);
    ...
    void haversineDistance_twoPoints_calculatesCorrectly() {
        double distance = virtualCaravanService.haversineDistance(108.94, 34.26, 103.83, 36.06);
    ...
    void getJourneyEvents_limit10_returns10OrFewer() {
        ...
        List<CaravanJourneyEventDTO> result = virtualCaravanService.getJourneyEvents(1L, 10);
    ...
    void triggerRandomEvent_positiveEvent_shouldIncreaseGoldAndMorale() {
        ...
        CaravanJourneyEventDTO result = virtualCaravanService.triggerRandomEvent(caravan, currentWp);
    ...
    void startJourney_fromTravelingState_throwsIllegalState() {
        ...
        assertThrows(IllegalStateException.class, () -> virtualCaravanService.startJourney(1L));
    }
    ...
    void pauseJourney_fromRestingState_throwsIllegalState() {
        ...
        assertThrows(IllegalStateException.class, () -> virtualCaravanService.pauseJourney(1L));
    }
    ...
    void getVirtualCaravan_wrongId_throwsIllegalArgument() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> virtualCaravanService.getVirtualCaravan(99999L));
    ...
    void deleteVirtualCaravan_wrongId_throwsIllegalArgument() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> virtualCaravanService.deleteVirtualCaravan(99999L));
        assertThat(ex.getMessage()).contains("驼队不存在");
    }
    ...
    void startJourney_nullCaravanId_wrappedCorrectly() {
        ...
        assertThrows(IllegalArgumentException.class, () -> virtualCaravanService.startJourney(99999L));
    }
    ...
    void getCaravanBySession_noCaravans_returnsNull() {
        ...
        VirtualCaravanDTO result = virtualCaravanService.getCaravanBySession("nonexistent-session");
