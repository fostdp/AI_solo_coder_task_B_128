...
class DynastyAnalyzerServiceTest {

    @Mock
    private DynastyRouteRepository dynastyRouteRepository;

    @InjectMocks
    private DynastyAnalyzerService dynastyAnalyzerService;
    ...
    void getAllDynasties_shouldGroupByDynastyAndSortChronologically() {
        ...
        List<DynastyComparisonDTO> result = dynastyAnalyzerService.getAllDynasties();
    ...
    void getRoutesByDynasty_tangShouldReturnThreeRoutes() {
        ...
        List<DynastyRouteDTO> result = dynastyAnalyzerService.getRoutesByDynasty("TANG");
    ...
    void compareDynasties_tangVsMing_shouldShowTangSuperior() {
        ...
        Map<String, DynastyComparisonDTO> result = dynastyAnalyzerService.compareDynasties("TANG", "SONG");
    ...
    void getDynastyTimeline_shouldSortByStartYear() {
        ...
        List<DynastyRouteDTO> result = dynastyAnalyzerService.getDynastyTimeline();
    ...
    void toDTO_shouldCorrectlyConvertCoordinates() {
        ...
        DynastyRouteDTO dto = dynastyAnalyzerService.toDTO(route);
    ...
    void buildComparisonDTO_shouldCalculateCorrectAverages() {
        ...
        Map<String, DynastyComparisonDTO> result = dynastyAnalyzerService.compareDynasties("TANG", "XIA");
    ...
    void getRoutesByDynasty_nonexistentDynasty_returnsEmptyList() {
        ...
        List<DynastyRouteDTO> result = dynastyAnalyzerService.getRoutesByDynasty("XIA");
    ...
    void getAllDynasties_repositoryThrowsRuntimeException_propagates() {
        ...
        assertThrows(RuntimeException.class, () -> dynastyAnalyzerService.getAllDynasties());
    }
    ...
    void compareDynasties_nullDynastyA_handlesGracefully() {
        ...
        Map<String, DynastyComparisonDTO> result = dynastyAnalyzerService.compareDynasties(null, "TANG");
    ...
    void getRoutesByDynasty_specialCharactersInDynasty_noException() {
        ...
        List<DynastyRouteDTO> result = dynastyAnalyzerService.getRoutesByDynasty("汉'朝");
