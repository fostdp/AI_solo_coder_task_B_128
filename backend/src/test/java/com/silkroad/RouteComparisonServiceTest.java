...
import com.silkroad.repository.ModernRoadRepository;
...
class RouteComparisonServiceTest {
    ...
    void compareByModernRoadId_shouldCalculateCorrectAncientDays() {
        ...
        RouteComparisonDTO result = routeComparisonService.compareByModernRoadId(1L);
    ...
    void compareByAncientRouteId_twoMatchingRoads_returnsTwo() {
        ...
        List<RouteComparisonDTO> result = routeComparisonService.compareByAncientRouteId(1L);
    ...
    void compareAllPairs_threeValidPairs_returnsThree() {
        ...
        List<RouteComparisonDTO> result = routeComparisonService.compareAllPairs();
    ...
    void getAllModernRoads_returnsAll() {
        ...
        List<ModernRoadDTO> result = routeComparisonService.getAllModernRoads();
    ...
    void toDTO_convertsAllFields() {
        ...
        ModernRoadDTO dto = routeComparisonService.toDTO(road);
    ...
    void compareByModernRoadId_notExistentId_returnsNull() {
        ...
        RouteComparisonDTO result = routeComparisonService.compareByModernRoadId(99999L);
    ...
    void compareByAncientRouteId_notExistentId_returnsEmpty() {
        ...
        List<RouteComparisonDTO> result = routeComparisonService.compareByAncientRouteId(99999L);
